      ...
      <div style={{ padding: "2.5rem" }}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: "1.25rem" }}>
            <Label htmlFor="name" className="font-mono text-xs font-medium" style={{ display: "block", marginBottom: "0.5rem" }}>
              name
            </Label>
            <Input
              id="name"
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem", marginBottom: "1.5rem" }}>
            ...
            <div>
              <Label htmlFor="confirm" className="font-mono text-xs font-medium" style={{ display: "block", marginBottom: "0.5rem" }}>
                confirm
              </Label>
              <Input
                id="confirm"
